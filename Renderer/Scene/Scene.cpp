...
namespace SceneLayer
{
        ...
        : _lightManager()
    {
        ...
        light->SetDirection(DirectX::XMVectorSet(0.5f, -1.0f, 0.2f, 0.0f));
        light->SetColor(DirectX::XMVectorSet(1.0f, 1.0f, 1.0f, 1.0f));
    ...
    bool Scene::LoadScene(const std::string& filepath, Core::GraphicsCommandList& commandList)
    {
        ...
        {
            std::shared_ptr<StaticObject> node = std::make_shared<StaticObject>(this);
