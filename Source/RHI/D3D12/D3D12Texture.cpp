...
namespace rhi::d3d12
{
    D3D12Texture::D3D12Texture(rhi::Device* device, D3D12MA::Allocator* allocator, const TextureDescription& description, ResourceState initialState, const std::string& name)
