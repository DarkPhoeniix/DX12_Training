...
namespace dx12
{
    ...
    public:
        ...
        void SetViewport(const CD3DX12_VIEWPORT& viewport, const CD3DX12_RECT& scissorRectangle);
        ...
        void ClearRTV(D3D12_CPU_DESCRIPTOR_HANDLE renderTargetView, const float color[4], CD3DX12_RECT* rectangle = nullptr);
        ...
        void ClearDSV(D3D12_CPU_DESCRIPTOR_HANDLE depthStencilView, D3D12_CLEAR_FLAGS clearFlags = D3D12_CLEAR_FLAG_DEPTH, float depth = 1.0f, std::uint8_t stencil = 0, CD3DX12_RECT* rectangle = nullptr);
